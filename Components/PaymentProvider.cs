...
namespace OS_PayBox
{
    public class OS_PayBoxPaymentProvider : Nevoweb.DNN.NBrightBuy.Components.Interfaces.PaymentsInterface
    {
        ...
        public override string GetTemplate(NBrightInfo cartInfo)
        {
            ...
            templ = NBrightBuyUtils.RazorTemplRender(templateName, 0, "", info, "/DesktopModules/NBright/OS_PayBox", "config", Utils.GetCurrentCulture(), passSettings);
        ...
        private string GetReturnTemplate(OrderData orderData, bool paymentok, string paymenterror)
        {
            ...
            if (paymentok)
            {
                ...
                templ = NBrightBuyUtils.RazorTemplRender(displaytemplate, 0, "", info, "/DesktopModules/NBright/OS_PayBox", "config", Utils.GetCurrentCulture(), passSettings);
            }
            else
            {
